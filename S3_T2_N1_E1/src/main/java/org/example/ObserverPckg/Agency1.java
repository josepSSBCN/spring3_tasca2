...
public class Agency1 extends Observer {
    ...
    //region CONSTRUCTOR
    public Agency1(int quantityStockMarket1, int quantityStockMarket2, int quantityStockMarket3, Subject subjectIn,
                   String agencyNameIn) {
    ...
    public void update() {
        ...
        text = text.concat(String.format("Nova actualització:\n.- El valor total de les accions de la 'Empresa 1' " +
                        "és ara de: " + "%s (unitats: %s; valor/unitat: %s) "
                , quantityStockMarket1 * subject.getValueStockMarket1(), quantityStockMarket1,
                subject.getValueStockMarket1()));
